...
PG_KEYWORD("sum", SUM, COL_NAME_KEYWORD, BARE_LABEL)
PG_KEYWORD("super", SUPER_P, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("super_write", SUPER_WRITE, UNRESERVED_KEYWORD, BARE_LABEL)
